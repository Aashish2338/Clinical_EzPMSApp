...
public class AllAppUsersResponse {
    ...
    public List<AllAppUsersData> getAllAppUsersData() {
        return allAppUsersData;
    }

    public void setAllAppUsersData(List<AllAppUsersData> allAppUsersData) {
