...
public class AllAppNoticesResponse {
    ...
    public List<AllAppNoticesData> getAppNoticesData() {
        return appNoticesData;
    }

    public void setAppNoticesData(List<AllAppNoticesData> appNoticesData) {
